...
int opener_noncompliant(FILE *file) {
    int rc;
    fpos_t offset;
    ...
    data[BUFFERSIZE] = '\0';
    printf("fread in opener_noncompliant: %s\n", data);
...
int opener_compliant(FILE *file) {
    int rc;
    fpos_t offset;
    ...
    data[BUFFERSIZE] = '\0';
    printf("fread in opener_compliant: %s\n", data);
