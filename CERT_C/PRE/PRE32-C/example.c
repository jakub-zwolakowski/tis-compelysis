...
void func_noncompliant(const char *src) {
...
int main(void) {
  func_compliant("123456789012345678901234567890");
  func_noncompliant("123456789012345678901234567890");
  return 0;
}

// NOT DETECTED
// CMD: tis-analyzer --interpreter test_PRE32-C.c
