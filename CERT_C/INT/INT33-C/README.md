...
==6050==ERROR: UndefinedBehaviorSanitizer: FPE on unknown address 0x000000423257 (pc 0x000000423257 bp 0x7ffe543fa9e0 sp 0x7ffe543fa9b0 T6050)
    ...
    #2 0x7fd2da7cbbf6 in __libc_start_main /build/glibc-S9d2JN/glibc-2.27/csu/../csu/libc-start.c:310
...
==6057== Command: ./Division.out
==6057== 
==6057== 
==6057== Process terminating with default action of signal 8 (SIGFPE)
==6057==  Integer divide by zero at address 0x1002D3BCA0
==6057==    at 0x108623: f_noncompliant (Division.c:8)
==6057==    by 0x1086C8: main (Division.c:29)
==6057== 
==6057== HEAP SUMMARY:
==6057==     in use at exit: 0 bytes in 0 blocks
==6057==   total heap usage: 0 allocs, 0 frees, 0 bytes allocated
==6057== 
