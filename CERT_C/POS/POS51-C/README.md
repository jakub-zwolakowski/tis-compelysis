...
==12345== 
==12345== HEAP SUMMARY:
==12345==     in use at exit: 656 bytes in 4 blocks
==12345==   total heap usage: 11 allocs, 7 frees, 123,456 bytes allocated
==12345== 
==12345== 56 bytes in 1 blocks are definitely lost in loss record 1 of 4
==12345==    at 0x424242424242: malloc (in /usr/lib/valgrind/vgpreload_memcheck-amd64-linux.so)
==12345==    by 0x424242424242: create_bank_account (example_compliant.c:21)
==12345==    by 0x424242424242: main (example_compliant.c:102)
==12345== 
==12345== 56 bytes in 1 blocks are definitely lost in loss record 2 of 4
==12345==    at 0x424242424242: malloc (in /usr/lib/valgrind/vgpreload_memcheck-amd64-linux.so)
==12345==    by 0x424242424242: create_bank_account (example_compliant.c:21)
==12345==    by 0x424242424242: main (example_compliant.c:103)
==12345== 
...
==12345==    by 0x424242424242: main (example_compliant.c:125)
==12345== 
...
==12345==    by 0x424242424242: allocate_stack (allocatestack.c:627)
==12345==    by 0x424242424242: pthread_create@@GLIBC_2.2.5 (pthread_create.c:644)
==12345==    by 0x424242424242: main (example_compliant.c:129)
==12345== 
==12345== LEAK SUMMARY:
==12345==    definitely lost: 112 bytes in 2 blocks
