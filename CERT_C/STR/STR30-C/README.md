...
SUMMARY: UndefinedBehaviorSanitizer: SEGV (/home/qba/git/tis-compelysis/CERT_C/STR/STR30-C/example1.UBSan-out+0x424242424242) in f_noncompliant
==12345==ABORTING
```
### Valgrind
```
...
==12345==    at 0x424242424242: f_noncompliant (example1.c:3)
==12345==    by 0x424242424242: main (example1.c:13)
==12345== 
==12345== HEAP SUMMARY:
...
==12345==ERROR: UndefinedBehaviorSanitizer: SEGV on unknown address 0x424242424242 (pc 0x424242424242 bp 0x424242424242 sp 0x424242424242 T4242)
==12345==The signal is caused by a WRITE memory access.
    #0 0x424242424242 in main (/home/qba/git/tis-compelysis/CERT_C/STR/STR30-C/example1_noncompliant.UBSan-out+0x424242424242)
    #1 0x424242424242 in __libc_start_main /build/glibc-XXXXXX/glibc-XXXXXX.27/csu/../csu/libc-start.c:310
    #2 0x424242424242 in _start (/home/qba/git/tis-compelysis/CERT_C/STR/STR30-C/example1_noncompliant.UBSan-out+0x424242424242)

UndefinedBehaviorSanitizer can not provide additional info.
SUMMARY: UndefinedBehaviorSanitizer: SEGV (/home/qba/git/tis-compelysis/CERT_C/STR/STR30-C/example1_noncompliant.UBSan-out+0x424242424242) in main
==12345==ABORTING
```
### Valgrind
```
...
==12345== Process terminating with default action of signal 11 (SIGSEGV)
==12345==  Bad permissions for mapped region at address 0x424242424242
==12345==    at 0x424242424242: main (example1_noncompliant.c:3)
==12345== 
==12345== HEAP SUMMARY:
==12345==     in use at exit: 0 bytes in 0 blocks
==12345==   total heap usage: 0 allocs, 0 frees, 0 bytes allocated
