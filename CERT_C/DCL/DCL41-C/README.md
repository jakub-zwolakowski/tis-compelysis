...
==29241== Using Valgrind-3.13.0 and LibVEX; rerun with -h for copyright info
==29241== Command: ./example.out
==29241== 
==29241== Conditional jump or move depends on uninitialised value(s)
==29241==    at 0x4E9A9DA: vfprintf (vfprintf.c:1642)
==29241==    by 0x4EA3015: printf (printf.c:33)
==29241==    by 0x108682: f_noncompliant (example.c:13)
==29241==    by 0x1086F8: main (example.c:39)
==29241== 
==29241== Use of uninitialised value of size 8
==29241==    at 0x4E9696B: _itoa_word (_itoa.c:179)
==29241==    by 0x4E9A00D: vfprintf (vfprintf.c:1642)
==29241==    by 0x4EA3015: printf (printf.c:33)
==29241==    by 0x108682: f_noncompliant (example.c:13)
==29241==    by 0x1086F8: main (example.c:39)
==29241== 
==29241== Conditional jump or move depends on uninitialised value(s)
==29241==    at 0x4E96975: _itoa_word (_itoa.c:179)
==29241==    by 0x4E9A00D: vfprintf (vfprintf.c:1642)
==29241==    by 0x4EA3015: printf (printf.c:33)
==29241==    by 0x108682: f_noncompliant (example.c:13)
==29241==    by 0x1086F8: main (example.c:39)
==29241== 
==29241== Conditional jump or move depends on uninitialised value(s)
==29241==    at 0x4E9A114: vfprintf (vfprintf.c:1642)
==29241==    by 0x4EA3015: printf (printf.c:33)
==29241==    by 0x108682: f_noncompliant (example.c:13)
==29241==    by 0x1086F8: main (example.c:39)
==29241== 
==29241== Conditional jump or move depends on uninitialised value(s)
==29241==    at 0x4E9AC4C: vfprintf (vfprintf.c:1642)
==29241==    by 0x4EA3015: printf (printf.c:33)
==29241==    by 0x108682: f_noncompliant (example.c:13)
==29241==    by 0x1086F8: main (example.c:39)
==29241== 
...
==29241==   total heap usage: 1 allocs, 1 frees, 4,096 bytes allocated
==29241== 
==29241== All heap blocks were freed -- no leaks are possible
==29241== 
==29241== For counts of detected and suppressed errors, rerun with: -v
==29241== Use --track-origins=yes to see where uninitialised values come from
==29241== ERROR SUMMARY: 7 errors from 5 contexts (suppressed: 0 from 0)
```
